class PurchaseAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, manucipality: manucipality, address: address, building_name: building_name, purchase_id: purchase.id)
  end
end